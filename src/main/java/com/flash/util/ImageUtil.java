...
public class ImageUtil {
  ...
  public void Test() throws IOException {
    String path2 = "/Users/cdj990918/Downloads/flash";
    String pp = "/Users/cdj990918/Downloads/photo/";
    String [] files = new String[]{
      pp+"XL0_1304.jpeg"
    };
    List<String> strings = ImageUtil.generateThumbnail2Directory(path2, files);
    files = null;
    for (String ss : strings) System.out.println(ss);
  }
}
